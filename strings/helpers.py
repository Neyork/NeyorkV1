...
MHELP_4 = """✅<u>**Extra  Commands:**</u>
/mstart - Start the Neyork Music Bot.
/mhelp  - Get Commands Helper Menu with detailed explanations of commands.
/ping- Ping the Bot and check Ram, Cpu etc stats of Neyork.
