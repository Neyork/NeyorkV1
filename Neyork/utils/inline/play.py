...
def track_markup(_, videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text=_["CLOSE_BUTTON"], url=f"https://t.me/NeyorkSupport",
            )
        ],
    ]
    return buttons
...
def stream_markup(_, videoid):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text=_["PL_B_3"], url=f"https://t.me/iNeyork"
            ),
        ],
        [
            InlineKeyboardButton(
                text=_["CLOSEMENU_BUTTON"], url=f"https://t.me/NeyorkUpdate"
            )
        ],
    ]
    return buttons
...
def livestream_markup(_, videoid, user_id, mode):
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text=_["CLOSEMENU_BUTTON"], url=f"https://t.me/NeyorkSupport",
            ),
        ],
    ]
    return buttons
